...
// Fetch and update the user's streak data
document.addEventListener('DOMContentLoaded', function() {
  var userStreak = fetchUserStreak(); // Implement the fetchUserStreak function to get the user's streak from the server
  document.getElementById('streak-value').textContent = userStreak;
});
...
const courses = ['GRE', 'GATE', 'CAT', 'GMAT', 'IELTS'];
...
searchBox.addEventListener('keypress', function(e) {
  if (e.key === 'Enter') {
    ...
    if (query.includes('gre')) {
      window.location.href = 'gre.html'; // Update with the correct URL
    } else if (query.includes('gate')) {
      window.location.href = 'gate.html'; // Update with the correct URL
    } else if (query.includes('cat')) {
      window.location.href = 'cat.html'; // Update with the correct URL
    } else if (query.includes('gmat')) {
      window.location.href = 'gmat.html'; // Update with the correct URL
    } else if (query.includes('ielts')) {
      window.location.href = 'ielts.html'; // Update with the correct URL
    } else {
